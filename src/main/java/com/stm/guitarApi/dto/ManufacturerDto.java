...
public class ManufacturerDto implements Serializable {
	...
	public static ManufacturerDto newInstance(String id, String name, String formerlyCalled, int foundedYear, String foundedPlace,
			String founder, String headquarters, String areaServed, String website, String logoBase64) {
		return new ManufacturerDto(id, name, formerlyCalled, foundedYear, foundedPlace, founder, headquarters,
				areaServed, website, logoBase64);
	}
	
	private ManufacturerDto() {}
	
	private ManufacturerDto(String id, String name, String formerlyCalled, int foundedYear, String foundedPlace,
			String founder, String headquarters, String areaServed, String website, String logoBase64) {
		super();
		this.id = id;
		this.name = name;
	...
	public String toString() {
		...
		builder.append("ManufacturerDto [id=");
		builder.append(id);
		builder.append(", name=");
		builder.append(name);
